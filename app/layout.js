              ...
              <div className="flex justify-between items-center h-16">
                ...
                <div className="hidden md:block">
                  <div className="ml-10 flex items-baseline space-x-4">
                    <Link href="/" className="text-gray-900 hover:text-blue-600 rounded-md text-md font-bold transition-colors">Home</Link>
                    <Link href="/MyPrompts" className="text-gray-900 hover:text-blue-600 rounded-md text-md font-bold transition-colors">My Prompts</Link>
